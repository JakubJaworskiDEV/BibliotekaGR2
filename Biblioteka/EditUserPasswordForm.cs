...
namespace Biblioteka
{
    ...
    public partial class EditUserPasswordForm : Form
    {
        ...
        private void BtnSaveUserPassword_Click(object sender, EventArgs e)
        {
            ...
            var result = MessageBox.Show("Czy na pewno chcesz zaktualizować hasło?", "Potwierdzenie", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            try
            {
                ...
                string updatePassword = "UPDATE Uzytkownik SET Haslo = @password WHERE Login = @login";
